...
<head>
    ...
    <link rel="stylesheet" href="/theme/vendor/daterange/daterange.css" />
...
<body>
        ...
        <nav id="sidebar" class="sidebar-wrapper">
            ...
            <div class="sidebar-brand">
                <a href="index.html" class="logo">
                    <img src="/theme/img/logo.svg" alt="Bootstrap Gallery" />
                </a>
            </div>
            <!-- Sidebar brand end  -->
                    ...
                    <ul class="header-actions">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="user-img away">
                                                <img src="/theme/img/user.png" alt="Bootstrap Templates">
                                            </div>
                                            <div class="details">
                                                <div class="user-title">Larson</div>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="user-img busy">
                                                <img src="/theme/img/user10.png" alt="Bootstrap Gallery">
                                            </div>
                                            <div class="details">
                                                <div class="user-title">Angela</div>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="user-img online">
                                                <img src="/theme/img/user6.png" alt="Best AI Admin Dashboards">
                                            </div>
                                            <div class="details">
                                                <div class="user-title">Ethan</div>
                        ...
                        <li class="dropdown">
                            <a href="#" id="userSettings" class="user-settings" data-bs-toggle="dropdown"
                                ...
                                <span class="avatar">
                                    <img src="/theme/img/user7.png" alt="Admin Dashboards">
  ...
  ************* -->
    <!-- Slimscroll JS -->
    <script src="/theme/vendor/slimscroll/slimscroll.min.js"></script>
    <script src="/theme/vendor/slimscroll/custom-scrollbar.js"></script>

    <!-- Daterange -->
    <script src="/theme/vendor/daterange/daterange.js"></script>
    <script src="/theme/vendor/daterange/custom-daterange.js"></script>

    <!-- Polyfill JS -->
    <script src="/theme/vendor/polyfill/polyfill.min.js"></script>

    <!-- Apex Charts -->
    <script src="/theme/vendor/apex/apexcharts.min.js"></script>
    <script src="/theme/vendor/apex/admin/visitors.js"></script>
    <script src="/theme/vendor/apex/admin/deals.js"></script>
    <script src="/theme/vendor/apex/admin/income.js"></script>
